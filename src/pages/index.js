    ...
    <section>
      ...
      Speak Freely, Earn Seamlessly.
       Your Voice , Your Rewards!
        ...
        <div>
          <button className='px-4 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-200 via-sky-500 to-pink-500 hover:bg-slate-200 text-white '>Earn</button>
